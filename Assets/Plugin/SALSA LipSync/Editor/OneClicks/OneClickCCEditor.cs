...
namespace CrazyMinnow.SALSA.OneClicks
{
	...
	public class OneClickCCEditor : Editor
	{
		...
		public static SalsaOneClickChoice SalsaOneClickSetup = OneClickCC3.Setup;

		public delegate void EyesOneClickChoice(GameObject gameObject);
		public static EyesOneClickChoice EyesOneClickSetup = OneClickCC3Eyes.Setup;

		[MenuItem("GameObject/Crazy Minnow Studio/SALSA LipSync/One-Clicks/Reallusion/CC4")]
		public static void OneClickSetup_CC4()
		{
			SalsaOneClickSetup = OneClickCC4.Setup;
			EyesOneClickSetup = OneClickCC3Eyes.Setup;

			OneClickSetup();
		}
		//Added Alx
		[MenuItem("GameObject/Crazy Minnow Studio/SALSA LipSync/One-Clicks/Revitalize/CC4")]
		public static void OneClickSetup_Revitalize()
		{
			SalsaOneClickSetup = OneClickCC4RevitalizeEdition.Setup;
			EyesOneClickSetup = OneClickCC3Eyes.Setup;

			OneClickSetup();
		}

		[MenuItem("GameObject/Crazy Minnow Studio/SALSA LipSync/One-Clicks/Revitalize/CC4 Game Ready Build")]
		public static void OneClickSetup_RevitalizeGRB()
		{
			SalsaOneClickSetup = OneClickCC4GameReadyRevitalizeEdition.Setup;
			EyesOneClickSetup = OneClickCC3Eyes.Setup;
		...
		{
			SalsaOneClickSetup = OneClickCC4_GameReadyBuild.Setup;
			EyesOneClickSetup = OneClickCC3Eyes.Setup;
		...
		{
			SalsaOneClickSetup = OneClickCC3.Setup;
			EyesOneClickSetup = OneClickCC3Eyes.Setup;
