...
public class BlendshapeAnimator : MonoBehaviour
{
    ...
    public  void SetFExpression(Frame frame, Frame nextFrame, float frameTime)
    {
        ...
        float x = (Mathf.Lerp(frame.pose_Rx * 57.2958f, nextFrame.pose_Rx * 57.2958f, frameTime) - firstFrame.pose_Rx * 57.2958f) * param.pose_Rx_coef;
        float y = 180 + (Mathf.Lerp(frame.pose_Ry * 57.2958f, nextFrame.pose_Ry * 57.2958f, frameTime) - firstFrame.pose_Ry * 57.2958f) * param.pose_Ry_coef;
        float z = (Mathf.Lerp(frame.pose_Rz * 57.2958f, nextFrame.pose_Rz * 57.2958f, frameTime) - firstFrame.pose_Rz * 57.2958f) * param.pose_Rz_coef;
